...
- **主排版頁：`Test Book 6`**（node `643:21`）
- 舊版參考：`Test Book 5`、`Test Book 4`、`Test Book 3`、`Test Book 2`、`Test Book`
...
- **書眉**：左右**外側**直排 **卷題＋阿拉伯數字頁碼**；弟子序書眉為短題 **「序」**
- **插圖**：九天玄女（自序）、呂祖（第五卷）、四人圖（附錄一前）、封面圓圖（版權頁前）
